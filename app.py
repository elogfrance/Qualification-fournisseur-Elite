...
def afficher_dashboard_fournisseurs():
    st.title("📊 Délai moyen par fournisseur")
    ...
    if fichier:
        ...
        st.info("📥 Veuillez importer un fichier contenant les colonnes : Nom fournisseur, ARC reçu, Ready for pick up.")
